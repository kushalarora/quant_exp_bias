...
@TokenIndexer.register("qeb_pretrained_transformer")
class QEBPretrainedTransformerIndexer(TokenIndexer[int]):
    """
    ...
    def __eq__(self, other):
        if isinstance(other, QEBPretrainedTransformerIndexer):
