...
main_args, serialization_dir, param_path, experiment_id, experiment = initialize_experiments('artificial_lang/reinforce_experiments', 
                                                                                 param_path='training_configs/artificial_grammar/artificial_grammar_rl.jsonnet',
                                                                                 debug=args.debug)
...
if args.all:
    for num_samples, num_runs in num_samples_and_runs:
        reinforce_experiments(main_args, serialization_dir, param_path, num_samples, num_runs)
else:
    reinforce_experiments(main_args, serialization_dir, param_path, args.num_samples, args.num_runs)
