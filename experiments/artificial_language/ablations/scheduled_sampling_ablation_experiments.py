...
args = get_experiment_args("artificial_language", "scheduled_sampling_ablation_experiments")
...
if args.all:
    for num_samples, num_runs in num_samples_and_runs:
        scheduled_sampling_ablation_experiments(scheduled_sampling_ratios, main_args,
                                                serialization_dir, param_path,
                                                num_samples, num_runs)
else:
    scheduled_sampling_ablation_experiments(scheduled_sampling_ratios, main_args,
                                            serialization_dir, param_path,
                                            args.num_samples, args.num_runs)
