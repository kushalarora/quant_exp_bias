...
python quant_exp_bias/run.py sample-oracle training_configs/artificial_grammar_composed.jsonnet -s results/artificial_grammar/${indir} -n ${NUM_SAMPLES} --include-package quant_exp_bias
...
python quant_exp_bias/run.py train training_configs/artificial_grammar_composed.jsonnet -s results/artificial_grammar/${indir}/"train_output" --include-package quant_exp_bias
