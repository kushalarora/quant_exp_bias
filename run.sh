...
python quant_exp_bias/run.py sample-oracle training_configs/artificial_grammar_sample_oracle.jsonnet -s results/artificial_grammar/${indir} -n ${NUM_SAMPLES} --include-package quant_exp_bias
