...
python quant_exp_bias/run.py sample-oracle training_configs/artificial_grammar.jsonnet -s results/artificial_grammar/${indir} -n ${NUM_SAMPLES}
...
python quant_exp_bias/run.py train training_configs/artificial_grammar.jsonnet -s results/artificial_grammar/${indir}/"train_output" 
python quant_exp_bias/run.py quantify-exposure-bias results/artificial_grammar/${indir}/"train_output/model.tar.gz" results/artificial_grammar/${indir}/oracle_samples_dev.txt --cuda-device 0 --output-dir results/artificial_grammar/${indir}/exp_bias/ --num-trials 20 
